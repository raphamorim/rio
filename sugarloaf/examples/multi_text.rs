    ...
    fn window_event(
        ...
        match event {
            ...
            WindowEvent::RedrawRequested => {
                ...
                sugarloaf.add_rect(5., 5., 200.0, 200.0, [1.0, 0.5, 0.5, 0.5]);
                sugarloaf.add_rect(220., 5., 200.0, 150.0, [1.0, 0.5, 0.5, 0.5]);
                sugarloaf.add_rect(440., 5., 320.0, 150.0, [1.0, 0.5, 0.5, 0.5]);

...
- Introduces `navigation.macos-enable-close-last-tab` which allows to close the last tab in MacOS. Default value is `false` and only work for native tabs for now (Ref: [#296](https://github.com/raphamorim/rio/issues/296))
- OSC 8 (Hyperlinks).

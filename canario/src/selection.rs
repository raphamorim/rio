...
impl Selection {
    ...
    pub fn to_range<H: crate::host::TerminalHost>(
        &self,
        term: &Crosswords<H>,
    ...
    fn range_semantic<H: crate::host::TerminalHost>(
        term: &Crosswords<H>,
        mut start: Pos,
        mut end: Pos,
    ) -> SelectionRange {
    ...
    fn range_lines<H: crate::host::TerminalHost>(
        term: &Crosswords<H>,
        start: Pos,
        end: Pos,
    ) -> SelectionRange {
...
mod tests {
    ...
    fn term(height: usize, width: usize) -> Crosswords<VoidHost> {
